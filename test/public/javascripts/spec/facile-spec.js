  ...
  (function(_facile) {
    ...
    return describe('facile', function() {
      ...
      return describe('appends classes', function() {
        ...
        it('ignores empty class values', function() {
          var data, result, template;
          template = '<div class="dog" />';
          data = {
            dog: {
        ...
        return it('supports attribute syntax', function() {
          var data, result, template;
          template = '<div class="dog" />';
          data = {
            'dog@class': 'cat'
          ...
          result = facile(template, data);
          return expect(result).toBe('<div class="dog cat"></div>');
        });
      });
    });
