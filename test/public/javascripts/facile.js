...
(function() {
  var $, bindArray, bindAttributeObject, bindData, bindNestedObject, bindObject, bindOrRemove, bindValue, facile, find, tagName;
  ...
  bindAttributeObject = function($template, key, value) {
    ...
    for (attr in value) {
      ...
      if (attr !== 'content') {
        if (attr === 'class') {
          _results.push($template.addClass(attrValue));
        } else {
