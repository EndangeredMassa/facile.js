(function() {
  var $, bindArray, bindAttributeObject, bindData, bindNestedObject, bindObject, bindOrRemove, bindValue, combineClasses, facile, find, tagName;
  ...
  bindArray = function($template, key, value) {
    ...
    if (tagName($root) === "TABLE") $root = $root.find('tbody');
